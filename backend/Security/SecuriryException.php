...
class SecuriryException extends Exception
{
    ...
    public static function becauseUserDontBelongToGroup(User $user, Group $group)
    {
     ...
     */
    public static function becauseItsAllowedOnlyToCertainUsers(array $users)
    {
